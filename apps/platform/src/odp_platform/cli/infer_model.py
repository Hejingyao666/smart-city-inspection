...
def _build_parser() -> argparse.ArgumentParser:
    ...
    p.add_argument("--batch", type=int, default=None, help="批大小 (视频/图片夹; 实时源会被强制为 1).")
    g_half = p.add_mutually_exclusive_group()
    g_half.add_argument("--half", action="store_true", default=None,
                        help="FP16 半精度推理 (现代 GPU 提速/省显存; CPU 无效).")
    g_half.add_argument("--no-half", dest="half", action="store_false",
                        help="强制 FP32 全精度.")
